-- Sakila Sample Database Schema - REORGANIZADO
-- Version 1.5 - Orden corregido para evitar problemas de llaves foráneas
...
-- ============================================
-- PASO 1: CREAR TABLAS BASE (SIN DEPENDENCIAS)
-- ============================================

--
-- Table: country (sin dependencias)
--
...
--
-- Table: language (sin dependencias)
--
...
--
-- Table: category (sin dependencias)
--
...
-- ============================================
-- PASO 2: CREAR TABLAS CON DEPENDENCIAS NIVEL 1
-- ============================================

--
-- Table: city (depende de country)
--
CREATE TABLE city (
...
--
-- Table: film (depende de language)
--
CREATE TABLE film (
...
-- ============================================
-- PASO 3: CREAR TABLAS CON DEPENDENCIAS NIVEL 2
-- ============================================

--
-- Table: address (depende de city)
--
...
--
-- Table: film_text (depende de film - para búsquedas fulltext)
--
...
-- ============================================
-- PASO 4: CREAR TABLAS CON DEPENDENCIAS NIVEL 3
-- ============================================

--
-- Table: store (necesita address y staff - se crea sin FK manager por ahora)
--
CREATE TABLE store (
...
--
-- Table: staff (depende de address y store)
--
CREATE TABLE staff (
...
--
-- Table: customer (depende de address y store)
--
...
--
-- Table: inventory (depende de film y store)
--
...
-- ============================================
-- PASO 5: CREAR TABLAS CON DEPENDENCIAS NIVEL 4
-- ============================================

--
-- Table: rental (depende de inventory, customer y staff)
--
CREATE TABLE rental (
...
-- ============================================
-- PASO 6: CREAR TABLAS CON DEPENDENCIAS NIVEL 5
-- ============================================

--
-- Table: payment (depende de customer, staff y rental)
--
...
-- ============================================
-- PASO 7: CREAR TABLAS DE RELACIÓN MANY-TO-MANY
-- ============================================

--
-- Table: film_actor (depende de film y actor)
--
...
--
-- Table: film_category (depende de film y category)
--
...
-- ============================================
-- PASO 8: AGREGAR TODAS LAS LLAVES FORÁNEAS
-- ============================================

-- Llaves foráneas para city
...
-- Llave foránea circular para store (manager_staff_id)
...
-- Llaves foráneas para film_actor
...
-- Llaves foráneas para film_category
...
-- ============================================
-- PASO 9: CREAR TRIGGERS PARA film_text
-- ============================================
...
-- ============================================
-- PASO 11: CREAR PROCEDIMIENTOS Y FUNCIONES
-- ============================================
...
-- ============================================
-- PASO 12: RESTAURAR CONFIGURACIONES
-- ============================================
